...
const Navbar = () => {
  ...
  return (
    <header className="bg-black-wash/95 border-b border-tawny-olive/50 shadow-xl shadow-corn-harvest/30 p-3 fixed w-full top-0 left-0 z-50">
      ...
      {isMenuOpen && (
        <div className="absolute top-0 left-0 w-full h-screen bg-black-wash/80 flex flex-col items-center justify-center space-y-8 md:hidden backdrop-blur-sm z-40">
          <NavLink
            to="/"
            onClick={closeMenu}
            className={({ isActive }) =>
